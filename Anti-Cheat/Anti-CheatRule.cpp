...
NTSTATUS UpdateWhiteList(_Inout_ LIST_ENTRY* pWhiteListHeader)
{
    ...
    WCHAR* pWhiteListBuffer[] = { swDecryptedSteamExeString, swDecryptedAkrosExeString, swDecryptedAkrosLauncherExeString, /*swDecryptExplorerString,*/ swDecryptedCsrssExeString ,0x00};
...
NTSTATUS UpdateProtectProcessList(LIST_ENTRY* pListHeader)
{
    LIST_ENTRY* pEntry = NULL;
    ANTI_CHEAT_PROTECT_PROCESS_DATA* pData = NULL;
    WCHAR* ProtectNames[] = { L"Target.exe" , L"notepad.exe" ,NULL};
    ULONG i = 0;
