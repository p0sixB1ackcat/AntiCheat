// Ring 3 compatible version of salsa20.cpp
// Add typedefs before including salsa20.h
...
// Rest is unchanged except for the removal of VM macros
// -----
							...
							uint32_t buflen)
{
	...
	void (*expand)(uint8_t *, uint8_t *, uint8_t *) = nullptr;
	...
	if (expand == nullptr || key == nullptr || nonce == nullptr || buf == nullptr)
		return S20_FAILURE;
